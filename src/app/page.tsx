...
export default async function Dashboard() {
  ...
  const { data: transactions } = await supabase
    ...
    .limit(10);
  const recentTransactions = (transactions ?? []) as DashboardTransaction[];
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden flex flex-col min-h-[520px] max-h-[70vh]">
        ...
        {/* Recent Activity */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden flex flex-col min-h-[520px] max-h-[70vh]">
