...
import { LayoutDashboard, Package, BotMessageSquare, Settings, Sparkles } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 hidden md:flex flex-col text-slate-100 h-full shrink-0">
      ...
      <div className="p-4 border-t border-slate-800 shrink-0">
        <button className="flex items-center space-x-3 px-3 py-2.5 rounded-lg w-full text-left text-slate-400 hover:text-white hover:bg-slate-800 transition-colors duration-200">
